...
export const ERROR_CODES = {
	...
	E_BATCH_NOT_WRAPPABLE: { defaultHttpStatus: 409, retryable: false, origin: 'server' },
	E_WRAPUP_ROUND_LIMIT: { defaultHttpStatus: 409, retryable: false, origin: 'server' },
	E_FIX_RUN_IN_FLIGHT: { defaultHttpStatus: 409, retryable: false, origin: 'server' },
	E_SESSION_ARCHIVED: { defaultHttpStatus: 409, retryable: false, origin: 'server' },
	E_PIPELINE_STAGE_DISABLED: { defaultHttpStatus: 409, retryable: false, origin: 'server' },
	E_AGENT_LOGIN_PROBE_FAILED: { defaultHttpStatus: 409, retryable: true, origin: 'server' },
